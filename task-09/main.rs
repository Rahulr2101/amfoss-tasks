...
fn main() {
    ...
    let crypto_name_selector = Selector::parse("p.chakra-text.css-rkws3").expect("Could not create selector.");
    let crypto_price_selector = Selector::parse("td div.css-0").expect("Could not create selector.");
